...
// The homepage shop band while the storefront is open. The homepage picks
// between this and ShopClosed on SHOP_ENABLED, so nothing here has to account
// for the shop being off — every card and the CTA link into a live storefront.
